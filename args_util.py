...
def parse_args(args):
    ...
    if config_dict["-e"] == "fs" or config_dict["-e"] == "fs_cvae" or config_dict["-e"] == "lda_cvae" or config_dict["-e"] == "lda_smote":
        config_dict["-cp"] = find(args, "-cp")
        config_dict["-ep"] = find(args, "-ep")
    if config_dict["-e"] not in ["origin", "slice","slice_smote", "slice_cvae", "slice_mixup","resampling", "undersampling", "fs", "cvae", "fs_cvae", "smote", "mixup", "lda_cvae","lda_smote"]:
